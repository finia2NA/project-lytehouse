...
public class MainModel implements Iterable<BObject> {
     ...
     *
     * @param text Arraylist with BTexts that will be displayed
     */
    ...
    /**
     * returns an ArrayList containing all balls in the model.
     *
     * @returnan ArrayList containing all balls in the model.
     */
     ...
     *
     * @param ballIndex the ball to get.
     *
     * @return the ball.
     */
    ...
    public ArrayList<BObject> toArrayList() {
        // Maybe you should cache the current ArrayList in an object variable so all of
